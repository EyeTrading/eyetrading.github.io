...
!!! example "閃電K線"
    ...
    1. <span style="color:red;font-weight:bold;">一鍵置中</span>: 右鍵點擊可以快速將五檔價格拉回中間位置.
    2. <span style="color:red;font-weight:bold;">多時間週期K線</span>: 直接將個股的1分K、5分K、日K 整合在閃電下電介面上，並能即時更新.
